...
- `NOR-051`: Ficha del título de Cuidados Auxiliares de Enfermería (RD 1538/1995 — pendiente verificar).
- `NOR-052`: Ficha del título de Imagen para el Diagnóstico (RD 772/2014 — pendiente verificar).
- `CUR-046`: Currículo placeholder del ciclo GM Sanidad.
- `CUR-047`: Currículo placeholder del ciclo GS Sanidad.
